        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a class="btn btn-outline-info" href="{{route('personales.create')}}">Nuevo contrato de personal</a><br><br>
                        <div class="table-responsive">
                            <table class="table table-striped mt-15" id="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="" value="{{$personal->codigo}}">{{$personal->codigo}} </a>
                                        </td>
                                        ...
                                        <td>
                                            <div class="dropdown" style="position: absolute;">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                    ...
                                                    <li>
                                                        <form action="{{route('personales.destroy',$personal->id)}}" id="formulario-eliminar2" class="formulario-eliminar" method="POST">
                                                            @csrf
                                                            @method('Delete')
